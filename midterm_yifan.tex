...
%  \vspace{0pt}  
%  \includegraphics[width=.9\textwidth]{images/flowchart_3_crop.pdf}
% \end{minipage}
% \end{frame}
...
%  \node at ([xshift=-3.5cm,yshift=-3.5cm]current page.east) 
%   {\includegraphics[height=2cm,keepaspectratio]{images/flowchart_3_crop.pdf}};
% \end{frame}
